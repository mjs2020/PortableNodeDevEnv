...
user in an INI file next to ConsolePortable.exe called ConsolePortable.ini.
...
copy AppNamePortable.ini from this directory to ConsolePortable.ini next to
ConsolePortable.exe. The options in the INI file are as follows:
